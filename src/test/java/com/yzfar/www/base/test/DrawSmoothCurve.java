...
public class DrawSmoothCurve extends JPanel {
	private static final long serialVersionUID = -3571654697341390477L;
	private Point[] points = { new Point(0, 0), new Point(100, 100), new Point(200, -100), new Point(300, 100),new Point(330, -80), new Point(350, -70) };
